...
{
    // Az ellenség agresszív viselkedését meghatározó absztrakt osztály, amely az 'EnemyBehaviour' osztálytól öröklődik.
    // Az agresszív viselkedés további részleteit a leszármazott osztályok határozzák meg.
    public abstract class HostileEnemyBehaviour : EnemyBehaviour
    {
